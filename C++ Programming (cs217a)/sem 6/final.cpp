...
readFile(inData, v_itemID[], itemName[], itemsOrdered[rows], mfgPrice[], storePrice[], rows); 
...
{
	int rows = v_size();
	itemSort(v_itemName, v_itemID, v_itemsOrdered, v_mfgPrice, v_storePrice, rows);
