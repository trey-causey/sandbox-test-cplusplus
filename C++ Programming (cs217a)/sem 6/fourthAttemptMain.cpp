...
void readFile(ifstream& inData, vector<int> item_ID, vector<string> item_Name, vector<int> p_Ordered, 
              vector<double> manuf_Price, vector<double> selling_Price);
...
readFile(inData, v_itemID, v_itemName, v_itemsOrdered, v_mfgPrice, v_storePrice); 
              ...
              vector<double> manuf_Price, vector<double> selling_Price)
{
         ...
         {
                  inData.get();
                  vector<int>item_ID.push_back(inData);
